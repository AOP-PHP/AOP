...
PHP_METHOD(AopJoinpoint, process){
    ...
    if (obj->current_pointcut->kind_of_advice & AOP_KIND_PROPERTY) {
        ...
        test_pointcut_and_execute_matching_advice(obj->pos, obj->advice, obj->ex, obj->object, obj->scope, obj->called_scope, obj->args_overloaded, obj->args, obj->to_return_ptr_ptr, obj->fci, 0);
	//zend_execute_ex(obj->ex TSRMLS_CC);
